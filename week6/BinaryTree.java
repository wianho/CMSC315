 ...
 public class BinaryTree {
     ...
     private Node parseNode(String input, int[] index) throws SyntaxException {
         if (index[0] >= input.length()) {
             throw new SyntaxException("Unexpected end of input: missing closing parenthesis");
         }
         ...
         // Check if there's still room to parse the left and right children
         if (index[0] >= input.length()) {
             throw new SyntaxException("Unexpected end of input: missing children or parentheses");
         }
         ...
         // Check if there's still room to parse the right child
         if (index[0] >= input.length()) {
             throw new SyntaxException("Unexpected end of input: missing right child or parentheses");
         }
